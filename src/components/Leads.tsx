          ...
          >
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex gap-2">
                <button className="px-4 py-2 border border-border text-navy text-[10px] font-bold rounded-lg active:scale-95 transition-all">
                  Archive
                </button>
                <button className="px-4 py-2 bg-navy text-white text-[10px] font-bold rounded-lg active:scale-95 transition-all">
                  Follow Up
                </button>
              </div>
            </div>
