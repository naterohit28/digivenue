...
import { Search, Calendar, Users, Building2, ClipboardList } from 'lucide-react';
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button className="p-2 bg-surface text-navy rounded-lg hover:bg-navy/10 transition-colors">
                    <Building2 size={18} />
                  </button>
